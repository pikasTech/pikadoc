...
![image-20220601001455518](assets/image-20220601001455518.png)

初次打开需要等待一些插件自动安装，以后再打开就可以直接启动了。

![image-20220601001641800](assets/image-20220601001641800.png)

 cd 到 ~/pikascript/port/linux, 然后输入 `code .`，切换工作路径到 pikascript/port/linux

![image-20220601001904516](assets/image-20220601001904516.png)
...
![image-20220601002350438](assets/image-20220601002350438.png)

然后可以为标准库增加类，或者函数，例如，为 `PikaStdData.String` 类增加一个 `startswith()` 方法，首先在 PikaStdData.pyi 中的 `String` 类下面新增 ` startswith() ` 方法的声明。

![image-20220601003457155](assets/image-20220601003457155.png)
...
![image-20220601003545995](assets/image-20220601003545995.png)

接着在 PikaStdData_String.c 中实现这个函数。

![image-20220601003710360](assets/image-20220601003710360.png)
...
![image-20220601003830732](assets/image-20220601003830732.png)

如果测试都通过了，就可以编写功能测试的代码了。

测试代码在 test 目录下。

![image-20220601003945867](assets/image-20220601003945867.png)
...
![image-20220601005050927](assets/image-20220601005050927.png)
...
![image-20220601005532339](assets/image-20220601005532339.png)
...
![image-20220601005949285](assets/image-20220601005949285.png)

然后在 gitee / github 中发起 Pull Request

![image-20220601010131920](assets/image-20220601010131920.png)
